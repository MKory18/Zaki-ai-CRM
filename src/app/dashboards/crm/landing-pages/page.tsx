...
export default function LandingPagesPage() {
  ...
  const createLandingPage = async () => {
    ...
    try {
      ...
      setCreateOpen(false);
      window.location.href = `/dashboards/crm/landing-pages/${data.landingPage.id}`;
                      ...
                      <tr key={lp.id} className="border-t border-[#e3e8ef] hover:bg-[#f8fafc]">
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-1">
                            <button title="تحرير" onClick={() => (window.location.href = `/dashboards/crm/landing-pages/${lp.id}`)}
