        ...
        {!loading && conn && conn.status !== 'CONNECTED' ? (
          <div className="flex-1 flex items-center justify-center px-6">
            <div className="text-center p-10 bg-white rounded-2xl border border-[#e2e8f0] max-w-md">
              ...
              {canManage && (
                <Link href="/dashboards/whatsapp/settings" className="mt-5 inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#b8256e] text-white text-sm font-semibold hover:opacity-90">
