    ...
    <AppLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-slate-900">{t.offers}</h1>
              ...
              <CardContent className="p-5 space-y-3">
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-2.5 rtl:space-x-reverse">
                    ...
                    <div>
                      ...
                      <h3 className="font-bold text-slate-900 text-sm mt-0.5">{o.name}</h3>
                    </div>
                  </div>
                ...
                <div className="p-3 bg-slate-50 rounded-xl border border-slate-100 flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <span className="text-xs text-slate-400 block">Pack Size</span>
                ...
                <div className="flex items-center justify-between text-xs pt-1">
                  <div className="flex items-center space-x-1 text-red-700 bg-red-50 px-2 py-0.5 rounded">
