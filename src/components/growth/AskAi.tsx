  ...
  return (
    <section className="rounded-xl border border-[var(--sys-border)] bg-[var(--sys-card)]">
      <header className="flex flex-wrap items-center gap-2 px-4 py-3 border-b border-[var(--sys-border)]">
        ...
        <span
          className="inline-flex items-center gap-1.5 text-[11px] text-[var(--sys-muted-foreground)] bg-[var(--sys-surface)] border border-[var(--sys-border)] rounded-lg px-2 py-0.5"
        ...
        <Link
          href="/settings/ai"
          className="ms-auto inline-flex items-center gap-1 text-[11px] text-[var(--sys-muted-foreground)] hover:text-[var(--sys-primary)]"
        >
      ...
      <div className="p-4 space-y-3">
        ...
        <div>
          <p className="text-[11px] text-[var(--sys-muted-foreground)] mb-1.5">ما الذي يُسمح له بقراءته:</p>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className="text-[10px] text-[var(--sys-muted)]">Ctrl + Enter</span>
          {picked.length === 0 && (
            <span className="text-[11px] text-[var(--sys-warning)]">اختر مصدر بيانات واحداً على الأقل.</span>
          )}
        </div>
        ...
        {answer && (
          <div className="rounded-lg border border-[var(--sys-border)] bg-[var(--sys-surface)] p-3">
            ...
            <p className="text-[10px] text-[var(--sys-muted)] mt-2">
