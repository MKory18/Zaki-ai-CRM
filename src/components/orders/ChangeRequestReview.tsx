          ...
          <>
            ...
            <label className="block">
              ...
              <input
                ...
                maxLength={500}
                className="w-full h-11 md:h-10 px-2 rounded-lg border border-[var(--sys-border)] bg-[var(--sys-card)] text-xs text-[var(--sys-foreground)] focus:outline-none focus:border-[var(--sys-primary)]"
              />
            </label>
