...
١. ما تقوله في أول جملة — باللهجة التي يكتب بها الزبون.
٢. أي خطر ينبغي أن تنتبه له: طلب سابق مرتجع، عنوان ناقص، رقم لم يردّ من قبل.
٣. صياغة رسالة قصيرة للواتساب إن لم يردّ.
...
١. ما الذي يُجهَّز الآن، مرتّباً بما يقلّل المشي بين الرفوف.
٢. ما الناقص، وكم ينقص منه بالضبط.
