...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    label: 'المال',
    routes: [
      r('/finance/collection', 'التحصيل والكشوف', 'FileSpreadsheet', ['settlement.upload', 'settlement.view'], 6),
      r('/finance/matching', 'المطابقة', 'GitCompare', ['settlement.review'], 6),
      r('/finance/wallets', 'المحافظ والحركات', 'Wallet', ['finance.cashbox'], 6),
      r('/finance/transfers', 'التحويلات', 'Repeat', ['finance.cashbox'], 6),
      r('/finance/closing', 'الإغلاق اليومي', 'Lock', ['finance.cashbox'], 6),
